...
export default function SplashCursor({
  ...
  useEffect(() => {
    ...
    function getWebGLContext(targetCanvas: HTMLCanvasElement) {
      ...
      let targetGl = targetCanvas.getContext('webgl2', params) as WebGL2RenderingContext | null;

      if (!targetGl) {
        targetGl = (targetCanvas.getContext('webgl', params) ||
      ...
      const isWebGL2 = 'drawBuffers' in targetGl;
      ...
      if (isWebGL2) {
        formatRGBA = getSupportedFormat(targetGl, targetGl.RGBA16F, targetGl.RGBA, halfFloatTexType);
        formatRG = getSupportedFormat(targetGl, targetGl.RG16F, targetGl.RG, halfFloatTexType);
        formatR = getSupportedFormat(targetGl, targetGl.R16F, targetGl.RED, halfFloatTexType);
      } else {
        formatRGBA = getSupportedFormat(targetGl, targetGl.RGBA, targetGl.RGBA, halfFloatTexType);
        formatRG = getSupportedFormat(targetGl, targetGl.RGBA, targetGl.RGBA, halfFloatTexType);
        formatR = getSupportedFormat(targetGl, targetGl.RGBA, targetGl.RGBA, halfFloatTexType);
      }
    ...
    function createFBO(
      ...
      if (!texture || !fbo) {
        throw new Error('Failed to allocate WebGL resources for SplashCursor.');
      }
